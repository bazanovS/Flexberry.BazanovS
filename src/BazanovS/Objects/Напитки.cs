    ...
    public class Напитки : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View НапиткиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("НапиткиE", typeof(IIS.BazanovS.Напитки));
                }
            }
            ...
            public static ICSSoft.STORMNET.View НапиткиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("НапиткиL", typeof(IIS.BazanovS.Напитки));
                }
            }
        }
    }
